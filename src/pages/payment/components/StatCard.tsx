import { Box, HStack, Select, Skeleton, Stat, StatHelpText, StatLabel, StatNumber, Tag } from '@chakra-ui/react';
...
export default function StatCard({ 
    ...
    isLoading,
    borderColor
}: { label:string; value:string; line?:string; growth?:string; bgColor?:string; borderColor?:string; isLoading?: boolean }) {
    return (
        <Box 
            bg="white" 
            px={6}

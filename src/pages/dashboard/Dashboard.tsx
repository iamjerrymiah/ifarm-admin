        ...
        <PageMainContainer title="Dashboard" description="Dashboard">
            <Box w={'100%'}>
                ...
                <SimpleGrid spacing={5} columns={[1,2,2,4]}>
                    ...
                    <DataInformation isLoading={statLoad} title='Inventory Status' value={formatNumberToShortForm(Number(stats?.total_inventories || 0), 3) ?? 0}/>
                    <DataInformation isLoading={statLoad} title='Pending Deliveries' value={formatNumberToShortForm(Number(stats?.pending_deliveries || 0), 3) ?? 0} vsColor='#B42318' dataValue={[45,5,30,1]}/>
